class Player < ActiveRecord::Base
  attr_accessible :firstname, :lastname, :position, :birth_date, :nationality, :birth_city, :birth_nation, :created_by_id, :name, :fields, :height_feet, :height_inches, :height_meters, :height
